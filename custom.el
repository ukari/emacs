...
(custom-set-variables
 ...
 '(package-selected-packages
   '(tern-auto-complete tern sr-speedbar speedbar-git-respect slime rjsx-mode renpy rainbow-mode rainbow-delimiters paredit package-lint olivetti monokai-theme markdown-mode lsp-mode lsp-haskell json-mode imenu-list haskell-mode fountain-mode exec-path-from-shell diff-hl auctex)))
